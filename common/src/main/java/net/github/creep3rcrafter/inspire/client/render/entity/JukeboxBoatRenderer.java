...
public class JukeboxBoatRenderer extends EntityRenderer<Boat> {
    private final Map<Boat.Type, Pair<ResourceLocation, ListModel<Boat>>> boatResources;

    public JukeboxBoatRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    private static String getTextureLocation(Boat.Type type) {
        return "textures/entity/jukebox_chest_boat/" + type.getName() + ".png";
    }
