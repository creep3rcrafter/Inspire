...
public class InspireItems {
    ...
    public static final RegistrySupplier<Item> OAK_PLANK_WALL;
    public static final RegistrySupplier<Item> SPRUCE_PLANK_WALL;
    public static final RegistrySupplier<Item> BIRCH_PLANK_WALL;
    public static final RegistrySupplier<Item> JUNGLE_PLANK_WALL;
    public static final RegistrySupplier<Item> ACACIA_PLANK_WALL;
    public static final RegistrySupplier<Item> DARK_OAK_PLANK_WALL;
    public static final RegistrySupplier<Item> MANGROVE_PLANK_WALL;
    ...
    public static final RegistrySupplier<Item> JUNGLE_LOG_WALL;
    public static final RegistrySupplier<Item> ACACIA_LOG_WALL;
    public static final RegistrySupplier<Item> DARK_OAK_LOG_WALL;
    public static final RegistrySupplier<Item> MANGROVE_LOG_WALL;
    ...
    public static final RegistrySupplier<Item> STRIPPED_OAK_LOG_WALL;
    public static final RegistrySupplier<Item> STRIPPED_SPRUCE_LOG_WALL;
    public static final RegistrySupplier<Item> STRIPPED_BIRCH_LOG_WALL;
    public static final RegistrySupplier<Item> STRIPPED_JUNGLE_LOG_WALL;
    public static final RegistrySupplier<Item> STRIPPED_ACACIA_LOG_WALL;
    public static final RegistrySupplier<Item> STRIPPED_DARK_OAK_LOG_WALL;
    public static final RegistrySupplier<Item> STRIPPED_MANGROVE_LOG_WALL;
    ...
    public static final RegistrySupplier<Item> STRIPPED_OAK_WOOD_WALL;
    public static final RegistrySupplier<Item> STRIPPED_SPRUCE_WOOD_WALL;
    public static final RegistrySupplier<Item> STRIPPED_BIRCH_WOOD_WALL;
    public static final RegistrySupplier<Item> STRIPPED_JUNGLE_WOOD_WALL;
    public static final RegistrySupplier<Item> STRIPPED_ACACIA_WOOD_WALL;
    public static final RegistrySupplier<Item> STRIPPED_DARK_OAK_WOOD_WALL;
    public static final RegistrySupplier<Item> STRIPPED_MANGROVE_WOOD_WALL;
    ...
    public static final RegistrySupplier<Item> OAK_WOOD_WALL;
    public static final RegistrySupplier<Item> SPRUCE_WOOD_WALL;
    public static final RegistrySupplier<Item> BIRCH_WOOD_WALL;
    public static final RegistrySupplier<Item> JUNGLE_WOOD_WALL;
    public static final RegistrySupplier<Item> ACACIA_WOOD_WALL;
    public static final RegistrySupplier<Item> DARK_OAK_WOOD_WALL;
    public static final RegistrySupplier<Item> MANGROVE_WOOD_WALL;
    ...
    public static final RegistrySupplier<Item> OAK_LOG_FENCE;
    public static final RegistrySupplier<Item> SPRUCE_LOG_FENCE;
    public static final RegistrySupplier<Item> BIRCH_LOG_FENCE;
    public static final RegistrySupplier<Item> JUNGLE_LOG_FENCE;
    public static final RegistrySupplier<Item> ACACIA_LOG_FENCE;
    public static final RegistrySupplier<Item> DARK_OAK_LOG_FENCE;
    public static final RegistrySupplier<Item> MANGROVE_LOG_FENCE;
    ...
    public static final RegistrySupplier<Item> STRIPPED_OAK_LOG_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_SPRUCE_LOG_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_BIRCH_LOG_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_JUNGLE_LOG_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_ACACIA_LOG_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_DARK_OAK_LOG_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_MANGROVE_LOG_FENCE;
    ...
    public static final RegistrySupplier<Item> STRIPPED_OAK_WOOD_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_SPRUCE_WOOD_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_BIRCH_WOOD_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_JUNGLE_WOOD_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_ACACIA_WOOD_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_DARK_OAK_WOOD_FENCE;
    public static final RegistrySupplier<Item> STRIPPED_MANGROVE_WOOD_FENCE;
    ...
    public static final RegistrySupplier<Item> OAK_WOOD_FENCE;
    public static final RegistrySupplier<Item> SPRUCE_WOOD_FENCE;
    public static final RegistrySupplier<Item> BIRCH_WOOD_FENCE;
    public static final RegistrySupplier<Item> JUNGLE_WOOD_FENCE;
    public static final RegistrySupplier<Item> ACACIA_WOOD_FENCE;
    public static final RegistrySupplier<Item> DARK_OAK_WOOD_FENCE;
    public static final RegistrySupplier<Item> MANGROVE_WOOD_FENCE;
    ...
    public static final RegistrySupplier<Item> STEM;
    ...
    static {
        ...
        STEM = ITEMS.register("stem", () -> new BlockItem(InspireBlocks.STEM.get(), new Item.Properties().arch$tab(InspireCreativeTabs.TAB_INSPIRE)));
        CUT_SOUL_SANDSTONE = ITEMS.register("stem", () -> new BlockItem(InspireBlocks.CUT_SOUL_SANDSTONE.get(), new Item.Properties().arch$tab(InspireCreativeTabs.TAB_INSPIRE)));
        CRIMSON_SOUL_SOIL = ITEMS.register("stem", () -> new BlockItem(InspireBlocks.CRIMSON_SOUL_SOIL.get(), new Item.Properties().arch$tab(InspireCreativeTabs.TAB_INSPIRE)));
        WARPED_SOUL_SOIL = ITEMS.register("stem", () -> new BlockItem(InspireBlocks.WARPED_SOUL_SOIL.get(), new Item.Properties().arch$tab(InspireCreativeTabs.TAB_INSPIRE)));
     ...
     *///unused items
        ...
        OAK_PLANK_WALL = ITEMS.register("oak_plank_wall", ()-> new BlockItem(InspireBlocks.OAK_PLANK_WALL.get(), basicProperties("oak_plank_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        SPRUCE_PLANK_WALL = ITEMS.register("spruce_plank_wall", ()-> new BlockItem(InspireBlocks.SPRUCE_PLANK_WALL.get(), basicProperties("spruce_plank_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        BIRCH_PLANK_WALL = ITEMS.register("birch_plank_wall", ()-> new BlockItem(InspireBlocks.BIRCH_PLANK_WALL.get(), basicProperties("birch_plank_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        JUNGLE_PLANK_WALL = ITEMS.register("jungle_plank_wall", ()-> new BlockItem(InspireBlocks.JUNGLE_PLANK_WALL.get(), basicProperties("jungle_plank_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ACACIA_PLANK_WALL = ITEMS.register("acacia_plank_wall", ()-> new BlockItem(InspireBlocks.ACACIA_PLANK_WALL.get(), basicProperties("acacia_plank_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        DARK_OAK_PLANK_WALL = ITEMS.register("dark_oak_plank_wall", ()-> new BlockItem(InspireBlocks.DARK_OAK_PLANK_WALL.get(), basicProperties("dark_oak_plank_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        MANGROVE_PLANK_WALL = ITEMS.register("mangrove_plank_wall", ()-> new BlockItem(InspireBlocks.MANGROVE_PLANK_WALL.get(), basicProperties("mangrove_plank_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ...
        BIRCH_LOG_WALL = ITEMS.register("birch_log_wall", ()-> new BlockItem(InspireBlocks.BIRCH_LOG_WALL.get(), basicProperties("birch_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        JUNGLE_LOG_WALL = ITEMS.register("jungle_log_wall", ()-> new BlockItem(InspireBlocks.JUNGLE_LOG_WALL.get(), basicProperties("jungle_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ACACIA_LOG_WALL = ITEMS.register("acacia_log_wall", ()-> new BlockItem(InspireBlocks.ACACIA_LOG_WALL.get(), basicProperties("acacia_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        DARK_OAK_LOG_WALL = ITEMS.register("dark_oak_log_wall", ()-> new BlockItem(InspireBlocks.DARK_OAK_LOG_WALL.get(), basicProperties("dark_oak_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        MANGROVE_LOG_WALL = ITEMS.register("mangrove_log_wall", ()-> new BlockItem(InspireBlocks.MANGROVE_LOG_WALL.get(), basicProperties("mangrove_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ...
        STRIPPED_OAK_LOG_WALL = ITEMS.register("stripped_oak_log_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_OAK_LOG_WALL.get(), basicProperties("stripped_oak_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_SPRUCE_LOG_WALL = ITEMS.register("stripped_spruce_log_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_SPRUCE_LOG_WALL.get(), basicProperties("stripped_spruce_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_BIRCH_LOG_WALL = ITEMS.register("stripped_birch_log_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_BIRCH_LOG_WALL.get(), basicProperties("stripped_birch_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_JUNGLE_LOG_WALL = ITEMS.register("stripped_jungle_log_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_JUNGLE_LOG_WALL.get(), basicProperties("stripped_jungle_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_ACACIA_LOG_WALL = ITEMS.register("stripped_acacia_log_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_ACACIA_LOG_WALL.get(), basicProperties("stripped_acacia_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_DARK_OAK_LOG_WALL = ITEMS.register("stripped_dark_oak_log_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_DARK_OAK_LOG_WALL.get(), basicProperties("stripped_dark_oak_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_MANGROVE_LOG_WALL = ITEMS.register("stripped_mangrove_log_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_MANGROVE_LOG_WALL.get(), basicProperties("stripped_mangrove_log_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ...
        STRIPPED_OAK_WOOD_WALL = ITEMS.register("stripped_oak_wood_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_OAK_WOOD_WALL.get(), basicProperties("stripped_oak_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_SPRUCE_WOOD_WALL = ITEMS.register("stripped_spruce_wood_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_SPRUCE_WOOD_WALL.get(), basicProperties("stripped_spruce_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_BIRCH_WOOD_WALL = ITEMS.register("stripped_birch_wood_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_BIRCH_WOOD_WALL.get(), basicProperties("stripped_birch_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_JUNGLE_WOOD_WALL = ITEMS.register("stripped_jungle_wood_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_JUNGLE_WOOD_WALL.get(), basicProperties("stripped_jungle_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_ACACIA_WOOD_WALL = ITEMS.register("stripped_acacia_wood_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_ACACIA_WOOD_WALL.get(), basicProperties("stripped_acacia_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_DARK_OAK_WOOD_WALL = ITEMS.register("stripped_dark_oak_wood_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_DARK_OAK_WOOD_WALL.get(), basicProperties("stripped_dark_oak_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_MANGROVE_WOOD_WALL = ITEMS.register("stripped_mangrove_wood_wall", ()-> new BlockItem(InspireBlocks.STRIPPED_MANGROVE_WOOD_WALL.get(), basicProperties("stripped_mangrove_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ...
        OAK_WOOD_WALL = ITEMS.register("oak_wood_wall", ()-> new BlockItem(InspireBlocks.OAK_WOOD_WALL.get(), basicProperties("oak_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        SPRUCE_WOOD_WALL = ITEMS.register("spruce_wood_wall", ()-> new BlockItem(InspireBlocks.SPRUCE_WOOD_WALL.get(), basicProperties("spruce_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        BIRCH_WOOD_WALL = ITEMS.register("birch_wood_wall", ()-> new BlockItem(InspireBlocks.BIRCH_WOOD_WALL.get(), basicProperties("birch_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        JUNGLE_WOOD_WALL = ITEMS.register("jungle_wood_wall", ()-> new BlockItem(InspireBlocks.JUNGLE_WOOD_WALL.get(), basicProperties("jungle_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ACACIA_WOOD_WALL = ITEMS.register("acacia_wood_wall", ()-> new BlockItem(InspireBlocks.ACACIA_WOOD_WALL.get(), basicProperties("acacia_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        DARK_OAK_WOOD_WALL = ITEMS.register("dark_oak_wood_wall", ()-> new BlockItem(InspireBlocks.DARK_OAK_WOOD_WALL.get(), basicProperties("dark_oak_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        MANGROVE_WOOD_WALL = ITEMS.register("mangrove_wood_wall", ()-> new BlockItem(InspireBlocks.MANGROVE_WOOD_WALL.get(), basicProperties("mangrove_wood_wall").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ...
        OAK_LOG_FENCE = ITEMS.register("oak_log_fence", ()-> new BlockItem(InspireBlocks.OAK_LOG_FENCE.get(), basicProperties("oak_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        SPRUCE_LOG_FENCE = ITEMS.register("spruce_log_fence", ()-> new BlockItem(InspireBlocks.SPRUCE_LOG_FENCE.get(), basicProperties("spruce_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        BIRCH_LOG_FENCE = ITEMS.register("birch_log_fence", ()-> new BlockItem(InspireBlocks.BIRCH_LOG_FENCE.get(), basicProperties("birch_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        JUNGLE_LOG_FENCE = ITEMS.register("jungle_log_fence", ()-> new BlockItem(InspireBlocks.JUNGLE_LOG_FENCE.get(), basicProperties("jungle_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ACACIA_LOG_FENCE = ITEMS.register("acacia_log_fence", ()-> new BlockItem(InspireBlocks.ACACIA_LOG_FENCE.get(), basicProperties("acacia_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        DARK_OAK_LOG_FENCE = ITEMS.register("dark_oak_log_fence", ()-> new BlockItem(InspireBlocks.DARK_OAK_LOG_FENCE.get(), basicProperties("dark_oak_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        MANGROVE_LOG_FENCE = ITEMS.register("mangrove_log_fence", ()-> new BlockItem(InspireBlocks.MANGROVE_LOG_FENCE.get(), basicProperties("mangrove_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ...
        STRIPPED_OAK_LOG_FENCE = ITEMS.register("stripped_oak_log_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_OAK_LOG_FENCE.get(), basicProperties("stripped_oak_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_SPRUCE_LOG_FENCE = ITEMS.register("stripped_spruce_log_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_SPRUCE_LOG_FENCE.get(), basicProperties("stripped_spruce_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_BIRCH_LOG_FENCE = ITEMS.register("stripped_birch_log_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_BIRCH_LOG_FENCE.get(), basicProperties("stripped_birch_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_JUNGLE_LOG_FENCE = ITEMS.register("stripped_jungle_log_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_JUNGLE_LOG_FENCE.get(), basicProperties("stripped_jungle_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_ACACIA_LOG_FENCE = ITEMS.register("stripped_acacia_log_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_ACACIA_LOG_FENCE.get(), basicProperties("stripped_acacia_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_DARK_OAK_LOG_FENCE = ITEMS.register("stripped_dark_oak_log_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_DARK_OAK_LOG_FENCE.get(), basicProperties("stripped_dark_oak_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_MANGROVE_LOG_FENCE = ITEMS.register("stripped_mangrove_log_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_MANGROVE_LOG_FENCE.get(), basicProperties("stripped_mangrove_log_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ...
        STRIPPED_OAK_WOOD_FENCE = ITEMS.register("stripped_oak_wood_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_OAK_WOOD_FENCE.get(), basicProperties("stripped_oak_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_SPRUCE_WOOD_FENCE = ITEMS.register("stripped_spruce_wood_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_SPRUCE_WOOD_FENCE.get(), basicProperties("stripped_spruce_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_BIRCH_WOOD_FENCE = ITEMS.register("stripped_birch_wood_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_BIRCH_WOOD_FENCE.get(), basicProperties("stripped_birch_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_JUNGLE_WOOD_FENCE = ITEMS.register("stripped_jungle_wood_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_JUNGLE_WOOD_FENCE.get(), basicProperties("stripped_jungle_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_ACACIA_WOOD_FENCE = ITEMS.register("stripped_acacia_wood_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_ACACIA_WOOD_FENCE.get(), basicProperties("stripped_acacia_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_DARK_OAK_WOOD_FENCE = ITEMS.register("stripped_dark_oak_wood_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_DARK_OAK_WOOD_FENCE.get(), basicProperties("stripped_dark_oak_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        STRIPPED_MANGROVE_WOOD_FENCE = ITEMS.register("stripped_mangrove_wood_fence", ()-> new BlockItem(InspireBlocks.STRIPPED_MANGROVE_WOOD_FENCE.get(), basicProperties("stripped_mangrove_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ...
        OAK_WOOD_FENCE = ITEMS.register("oak_wood_fence", ()-> new BlockItem(InspireBlocks.OAK_WOOD_FENCE.get(), basicProperties("oak_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        SPRUCE_WOOD_FENCE = ITEMS.register("spruce_wood_fence", ()-> new BlockItem(InspireBlocks.SPRUCE_WOOD_FENCE.get(), basicProperties("spruce_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        BIRCH_WOOD_FENCE = ITEMS.register("birch_wood_fence", ()-> new BlockItem(InspireBlocks.BIRCH_WOOD_FENCE.get(), basicProperties("birch_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        JUNGLE_WOOD_FENCE = ITEMS.register("jungle_wood_fence", ()-> new BlockItem(InspireBlocks.JUNGLE_WOOD_FENCE.get(), basicProperties("jungle_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        ACACIA_WOOD_FENCE = ITEMS.register("acacia_wood_fence", ()-> new BlockItem(InspireBlocks.ACACIA_WOOD_FENCE.get(), basicProperties("acacia_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        DARK_OAK_WOOD_FENCE = ITEMS.register("dark_oak_wood_fence", ()-> new BlockItem(InspireBlocks.DARK_OAK_WOOD_FENCE.get(), basicProperties("dark_oak_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
        MANGROVE_WOOD_FENCE = ITEMS.register("mangrove_wood_fence", ()-> new BlockItem(InspireBlocks.MANGROVE_WOOD_FENCE.get(), basicProperties("mangrove_wood_fence").arch$tab(CreativeModeTabs.COLORED_BLOCKS)));
