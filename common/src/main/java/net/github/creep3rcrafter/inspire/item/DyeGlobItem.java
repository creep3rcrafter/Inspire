...
public class DyeGlobItem extends Item {
    private static final Map<DyeColor, DyeGlobItem> ITEM_BY_COLOR = Maps.newEnumMap(DyeColor.class);
    private final DyeColor dyeColor;

    public DyeGlobItem(DyeColor dyeColor, Properties properties) {
        super(properties);
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        ...
        if (!level.isClientSide) {
            ...
            level.addFreshEntity(thrownDyeGlob);
        }
