...
public class BreakerScreen extends AbstractContainerScreen<BreakerMenu> {
    private static final ResourceLocation CONTAINER_LOCATION = new ResourceLocation(InspireCommon.MOD_ID, "textures/gui/container/breaker.png");

    public BreakerScreen(BreakerMenu breakerMenu, Inventory inventory, Component component) {
        super(breakerMenu, inventory, component);
    }
