...
public class TrappedChestMinecartEntity extends MinecartChest {
    public TrappedChestMinecartEntity(EntityType<? extends TrappedChestMinecartEntity> entityType, Level level) {
